  ...
  return (
    <div>
      <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
        <div className="w-full p-6 m-auto bg-white rounded shadow-lg ring-2 ring-purple-800/50 lg:max-w-md max-h-screen">
          <div className='justify-center items-center w-full h-auto'>
            <h2 className='justify-center text-center font-bold text-purple-500'>Hotel Name</h2>
