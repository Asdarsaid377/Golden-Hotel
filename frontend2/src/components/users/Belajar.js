...
function Belajar() {
  return (
    <div className='flex bg-gray-700  col-span-2 w-full h-screen'>
      <aside className="w-[250px] h-screen" aria-label="Sidebar">
        <div className="overflow-y-auto h-screen  gap-4 bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 gap-4">
            <li className='gap-3'>
              <a href="#" className="flex mt-4 items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
              <a href="#" className="flex items-center mt-4 p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <main className='w-[calc(100%-250px)] bg-white '>
        <CardHotel />
      </main>
    </div>
  )
