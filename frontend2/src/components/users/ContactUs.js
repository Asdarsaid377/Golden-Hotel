...
function ContactUs() {
  return (
    <div>
      <section className="bg-gray-700 py-20  ml-16 overflow-hidden z-10 mt-7">
        <div className="container">
          <div className="flex flex-wrap lg:justify-between -mx-4">
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 lg:mb-0">
                <span className="block mb-4 text-base text-primary font-bold text-yellow-500">
                  Contact Us
                </span>
                <h2 className="
            text-white
            ...
            ">
                ...
                <p className="text-base text-body-color leading-relaxed mb-9 text-white">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eius tempor incididunt ut labore et dolore magna aliqua. Ut enim
                  adiqua minim veniam quis nostrud exercitation ullamco
                </p>
                <div className="flex mb-8 max-w-[370px] w-full text-white">
                  <div className="
               max-w-[60px]
               sm:max-w-[70px]
               w-full
               ...
               ">
                  ...
                  <div className="w-full text-white">
                    <h4 className="font-bold text-dark text-xl mb-1 text-white">Our Location</h4>
                    <p className="text-base text-body-color text-white">
                      Jl.H.Midi No 99,Cengkareng,Jakarta Barat
                    </p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full text-white">
                ...
                <div className="flex mb-8 max-w-[370px] w-full text-white">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">gmail@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
              <div className="bg-gray-600 rounded-lg p-8 sm:p-12 shadow-lg">
                <form className='bg-gray-600'>
                  <div className="mb-6">
                    <input type="text" placeholder="Your Name" className=" w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] outline-none focus-visible:shadow-none focus:border-primary " />
                  </div>
                  <div className="mb-6">
                  ...
                  <div className="mb-6">
                    <input type="text" placeholder="Your Phone" className=" w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] outline-none focus-visible:shadow-none focus:border-primary " />
                  </div>
                  <div className="mb-6">
                    <textarea rows={6} placeholder="Your Message" className="w-full rounded py-3 px-[14px] text-body-color text-base  border border-[f0f0f0] resize-none outline-none focus-visible:shadow-none focus:border-primary
                  " defaultValue={""} />
                  </div>
                  <div>
                    <button type="submit" className="w-full text-white bg-primary rounded border border-primary p-3 transition hover:bg-opacity-90">
                      Send Message
                    </button>
                  </div>
                </form>
