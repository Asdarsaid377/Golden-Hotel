...
function Navbar() {
  return (
    <div className='sticky top-0 opacity-80'>
      <nav className="bg-white fi border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 shadow-md sticky top-0 p-5 drop-shadow shadow-gray-700">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="https://flowbite.com/" className="flex items-center">
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-yellow-500">Golden Hotel</span>
          </a>
